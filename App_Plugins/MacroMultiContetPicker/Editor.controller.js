angular.module("umbraco").controller("MacroMultiContentPicker.controller", MacroMultiContentPicker);

function MacroMultiContentPicker($scope, dialogService, entityResource, editorState, $log, iconHelper, $routeParams, fileManager, contentEditingHelper) {
