angular.module("umbraco").controller("MacroRelatedLinksPicker.controller", MacroRelatedLinksPicker);

function MacroRelatedLinksPicker($rootScope, $scope, dialogService) {
